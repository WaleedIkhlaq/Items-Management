...
( function ( a, b ) {
    ...
    f.event = {
        ...
        dispatch: function ( c ) {
            ...
            var d = ( f._data ( this, "events" ) || {} )[ c.type ] || [], e = d.delegateCount,
                g = [].slice.call ( arguments, 0 ), h = !c.exclusive && !c.namespace, i = [], j, k, l, m, n, o, p, q, r,
                s, t;
    ...
    var V = "abbr|article|aside|audio|canvas|datalist|details|figcaption|figure|footer|header|hgroup|mark|meter|nav|output|progress|section|summary|time|video",
        ...
        bc = new RegExp ( "<(?:" + V + ")", "i" ), bd = /checked\s*(?:[^=]|=\s*.checked.)/i,
    ...
    bW = bR.exec ( bV.toLowerCase () ) || [], f.fn.extend ( {
        ...
        ajax: function ( a, c ) {
            ...
            var d = f.ajaxSetup ( {}, c ), e = d.context || d,
                ...
                i = f.Callbacks ( "once memory" ), j = d.statusCode || {}, k, l = {}, m = {}, n, o, p, q, r, s = 0, t,
                u, v = {
    ...
    f.fn.extend ( {
        show: function ( a, b, c ) {
            ...
            function g () {
                ...
                var b = f.extend ( {}, e ), c = this.nodeType === 1, d = c && f ( this ).is ( ":hidden" ), g, h, i, j,
                    k, l, m, n, o;
